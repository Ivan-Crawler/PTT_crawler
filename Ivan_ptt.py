...
class StartPageTypeError(Error):
    """Type of start page have to be a int or float."""
    pass
...
def crawl_ptt_page(Board_Name ='KoreaDrama' , start ='開始爬取的頁數' ,page_num= 5):
